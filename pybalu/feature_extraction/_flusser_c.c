...
static PyMethodDef __pyx_mdef_6pybalu_18feature_extraction_10_flusser_c_1flusser = {"flusser", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6pybalu_18feature_extraction_10_flusser_c_1flusser, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_moments); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_4 = (__pyx_t_171) ? __Pyx_PyObject_Call2Args(__pyx_t_2, __pyx_t_171, __pyx_t_172) : __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_172);
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_172 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_array); if (unlikely(!__pyx_t_172)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_172);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_f_labels); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_171 = NULL;
    if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_172))) {
      __pyx_t_171 = PyMethod_GET_SELF(__pyx_t_172);
      if (likely(__pyx_t_171)) {
        PyObject* function = PyMethod_GET_FUNCTION(__pyx_t_172);
        __Pyx_INCREF(__pyx_t_171);
        __Pyx_INCREF(function);
        __Pyx_DECREF_SET(__pyx_t_172, function);
      }
    }
    __pyx_t_4 = (__pyx_t_171) ? __Pyx_PyObject_Call2Args(__pyx_t_172, __pyx_t_171, __pyx_t_2) : __Pyx_PyObject_CallOneArg(__pyx_t_172, __pyx_t_2);
    __Pyx_XDECREF(__pyx_t_171); __pyx_t_171 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_172); __pyx_t_172 = 0;
    __pyx_t_172 = PyTuple_New(2); if (unlikely(!__pyx_t_172)) __PYX_ERR(0, 28, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_172);
    __Pyx_GIVEREF(__pyx_t_4);
    PyTuple_SET_ITEM(__pyx_t_172, 0, __pyx_t_4);
    __Pyx_INCREF(__pyx_v_f_moments);
    __Pyx_GIVEREF(__pyx_v_f_moments);
    PyTuple_SET_ITEM(__pyx_t_172, 1, __pyx_v_f_moments);
    __pyx_t_4 = 0;
    __pyx_r = __pyx_t_172;
    __pyx_t_172 = 0;
    goto __pyx_L0;
 ...
 *     cdef np.double_t f_moment1, f_moment2, f_moment3, f_moment4
 */
  __pyx_tuple__9 = PyTuple_Pack(9, __pyx_n_s_image, __pyx_n_s_show, __pyx_n_s_labels, __pyx_n_s_m, __pyx_n_s_f_moment1, __pyx_n_s_f_moment2, __pyx_n_s_f_moment3, __pyx_n_s_f_moment4, __pyx_n_s_f_moments); if (unlikely(!__pyx_tuple__9)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__9);
  __Pyx_GIVEREF(__pyx_tuple__9);
  __pyx_codeobj__10 = (PyObject*)__Pyx_PyCode_New(1, 2, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__9, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pybalu_feature_extraction__fluss, __pyx_n_s_flusser, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__10)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__flusser_c(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_flusser_c' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pybalu.feature_extraction._flusser_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
