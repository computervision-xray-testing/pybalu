...
def huint(image, region=None, *, show=False, labels=False):
    '''\
huint(image, region=None, *, show=False, labels=False)
...
class HuIntExtractor(FeatureExtractorBase):
    extractor_func = huint