...
from pybalu.feature_extraction._geometric_c import bw_perim
...
_disk[[0,0,0,0,1,1,-2,-2,-1,-1,-1,-1], [0,1,-2,-1,0,-1,0,-1,0,1,-2,-1]] = 0
...
def morphoreg(image, threshold=None):
    ...
    with warnings.catch_warnings():
        ...
        region = remove_small_holes(closed, R.size // 100.0, connectivity=2).astype(int)
