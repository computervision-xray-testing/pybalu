...
ext_module_fex_flusser = declare_cython_extension( "pybalu.feature_extraction._flusser_c", use_math=True, include_dirs=my_include_dirs)
ext_module_fex_geometric = declare_cython_extension( "pybalu.feature_extraction._geometric_c", use_math=True, include_dirs=my_include_dirs)
ext_module_fex_haralick = declare_cython_extension( "pybalu.feature_extraction._haralick_utils_c", use_math=True, include_dirs=my_include_dirs)
ext_module_fex_hog = declare_cython_extension( "pybalu.feature_extraction._hog_utils_c", use_math=True, include_dirs=my_include_dirs)
...
setup(
    ...
    classifiers = [ "Development Status :: 3 - Alpha",
                    ...
                    "License :: OSI Approved :: MIT License",  # not a standard classifier; CHANGE THIS
    ...
    #
    install_requires = ["numpy", "scipy", "matplotlib", "scikit-image", "scikit-learn", "tqdm"],    
    setup_requires = ["cython", "numpy", "scipy", "matplotlib", "scikit-image", "scikit-learn", "tqdm"],
